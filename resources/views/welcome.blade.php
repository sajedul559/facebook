                ...
                <div class="row">
                    <div class="pull-left text-center col-sm-7">
                        <div style="display:none">
                            <h3 class="text-primary">FaceClone helps you connect and share with the people in your life.</h3>
                            ...
                            <div class="signup-form">
                                ...
                                <form action="{{route('saveRegister')}}" method="POST">
                                    ...
                                    <div class="row form-group ">
                                        <div class="col-sm-12">
                                            <input type="text" placeholder="First Name" name="fname" class="input-lg col-sm-5" value="{{ old('fname') }}"/>
                                            @error('fname')
                                    ...
                                    <div class="form-group">
                                        <input type="password" placeholder="Password" name="password" value="{{ old('password') }}" class="input-lg col-sm-12"/>
                                        @error('password')
                                        <div class="alert alert-danger">{{$message}}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        <input type="password" placeholder="Confirm Password" name="password_confirmation" value="{{ old('password_confirmation') }}" class="input-lg col-sm-12"/>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-sm-4">
